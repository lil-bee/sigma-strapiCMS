...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.RichText &
      ...
      Schema.Attribute.DefaultTo<'We are a professional logistics partner delivering cargo solutions across land, sea, and air. We are a lean organization consist of people who expertise in logistics sector with long, substantial, and strong of experience. We gathered from national and multi-national logistics industry specialized in Shipping, Trucking, Supply Chain Solution, 3rd Party Logistics. We help businesses move faster, smarter and more securely.'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCtaBannerCtaBanner extends Struct.SingleTypeSchema {
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    footer_menu: Schema.Attribute.Component<'shared.footer-menu', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    subtitle: Schema.Attribute.Text &
      ...
      Schema.Attribute.DefaultTo<'From sea to sky, and everything in between \u2014 we move your cargo with care, speed, and precision.'>;
    title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
      ...
      Schema.Attribute.DefaultTo<'End-to-End Logistics Solutions You Can Count On'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMissionMission extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::mission.mission'
    >;
    missions: Schema.Attribute.Component<'shared.mission', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    title: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Our Missions'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPartnersLogoPartnersLogo
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    logos: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiVisionVision extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    quote: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'\u201CTo be a nationwide Integrated Project Logistics Top Of Mind.\u201D'>;
    title: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Our Visions'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
